...
em_plots_out1 = ipw.Output(layout=ipw.Layout(width="100%", min_height="%dpix"%(GRAPH_HEIGHT+50),
...
def update_view_max():
    em_slice_select.max = max(0,em_case_data[em_case_select.value][em_table_select.value].shape[0]-5)
    ...
    return ipw.TwoByTwoLayout(
            top_left=ipw.VBox([em_reset,
                               ...
                               layout=ipw.Layout(width='100%',
                                                 min_height='200px',
                                                 border="solid")),
            bottom_left=ipw.HBox([em_plots_out1]), layout=ipw.Layout(width="100%"))
